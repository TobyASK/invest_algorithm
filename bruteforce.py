...
def bruteforce(action_list, budget):
    """
    Algorithme de force brute pour trouver la meilleure combinaison.

    Args:
        action_list: Liste des actions disponibles
...
def main():
    ...
    # Exécution
    best_profit, best_combination = bruteforce(action_list, budget)
